...
func Unarchive(src, dest string, options ...UnarchiveOption) (*Archive, error) {
	...
	} else if strings.HasSuffix(src, ".tar") || strings.HasSuffix(src, ".tgz") || strings.HasSuffix(src, ".tar.gz") || strings.HasSuffix(src, ".tar.xz") || strings.HasSuffix(src, ".txz") || strings.HasSuffix(src, ".tar.bz2") || strings.HasSuffix(src, ".tbz2") {
