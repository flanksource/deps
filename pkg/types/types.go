...
type Package struct {
	...
	Envs           map[string]string      `json:"envs,omitempty" yaml:"envs,omitempty"`                       // Environment variables to export after installation. Supports template variables: {{.dir}}, {{.version}}, {{.name}}, {{.os}}, {{.arch}}
